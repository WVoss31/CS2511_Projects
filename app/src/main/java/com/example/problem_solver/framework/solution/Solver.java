...
import static com.example.problem_solver.framework.solution.Statistics.CIRCULARITIES;
import static com.example.problem_solver.framework.solution.Statistics.LENGTH;
import static com.example.problem_solver.framework.solution.Statistics.NUM_OPS;
import static com.example.problem_solver.framework.solution.Statistics.QUEUE_SIZE;
import static com.example.problem_solver.framework.solution.Statistics.TIME;
import static com.example.problem_solver.framework.solution.Statistics.VERTICES;
...
public abstract class Solver {
    ...
    private boolean success(Vertex u) {
        return ((State)u.getData()).equals(problem.getFinalState());
    }
}
